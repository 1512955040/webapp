...
<hr>
<p>需要完善的信息</p> 
 企业注册类型：<input type="text" name="registerType" value="${enterpriseService.register_type }"><br>
注册地址：<input type="text" name="register_address" value="${enterpriseService.register_address }"><br>
经营范围：<input type="text" name="business_scope" value="${enterpriseService.business_scope }"><br>
