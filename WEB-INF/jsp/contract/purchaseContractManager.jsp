...
<body>
<div  class = "div1">
      <div id = "title" style = "width:100%;height:10px; align:center;">供销合同管理</div><br/>
      <div id = "functionButton" style = "width:400px;height:30px; margin-right:0px;float:right;">
      <shiro:hasPermission name="purchaseContract:add">
        <a href = "purchaseContract/add"><input type = "button" value = "增加合同" /></a>
      </shiro:hasPermission>
      ...
      <div id = "ContractList">
        <form action = "contractManager" method = "">
          <table border = "1px" width = "1000px" align = "center">
           ...
           <c:forEach items="${ purchaseContract }" var="con" varStatus="loop">
              <tr align = "center">
                <td>${con.name}</td>
                ...
                <td>
                <shiro:hasPermission name="purchaseContract:view">
                   <a href="purchaseContract/view?purContactId=${con.id}">
                      <input type = "button" value = "查看合同详情"/>
                   </a>
                 </shiro:hasPermission>
                 
                 <shiro:hasPermission name="purchaseContract:addProject">
                   <a href="purchaseContract/addProject?purchaseConId=${con.id }">
